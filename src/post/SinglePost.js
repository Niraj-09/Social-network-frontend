...
class SinglePost extends Component{
    ...
    deleteConfirmed=()=>{
        let answer=window.confirm("Arue you sure you want to delete your post ?")
            ...
            return(
                ...
                <div className="card-body">
                    ...
                    />
                        ...
                        {like ?(
                            <h3 onClick={this.likeToggle}><i className="fa fa-thumbs-up text-success bg-dark"
                             style={{padding:'10px',borderRadius:'50%'}}/>
                             {" "}{likes} Like</h3>
                        ):(
                            <h3 onClick={this.likeToggle}>
                                <i className="fa fa-thumbs-down text-danger bg-dark" style={{padding:'10px',borderRadius:'50%'}}/>
                                {" "}{likes} Like
                            </h3>
                        )}
                    ...
                    <Link 
                        to={`/`}
                        className="btn btn-raised btn-primary btn-sn mr-5"
                    >    
                        Back to posts
                    </Link>
